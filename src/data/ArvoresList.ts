...
// const doubleEspressoImage = require("../../assets/arvores/Screenshot_3.png");
// const cortadoImage = require("../../assets/arvores/Screenshot_3.png");
// const mochaImage = require("../../assets/arvores/Screenshot_3.png");
// const redEyeImage = require("../../assets/arvores/Screenshot_3.png");

export const coffeeList: Arvores[] = [
  {
  ...
  },
  {
    ...
    image: arvore2,
    description:
      "A Quaresmeira é mais um dos tipos de árvores nativas indicadas para a arborização urbana, pois não apresenta raízes agressivas, tem fácil manutenção e crescimento lento. Sua altura fica entre 8 a ",
  },
  {
    name: "Jacarandá de Minas (Jacaranda Cuspidifolia)",
    image: arvore3,
    description:
      "O Jacarandá de Minas pode atingir até 10 m de altura. Por não ter raízes agressivas e apresentar boa resistência à poluição, a espécie é bastante utilizada na arborização urbana de grandes cidade",
  },
  {
    name: "Sibipiruna (Caesalpinia Peltophoroides)",
    image: arvore4,
    description:
      "Esse é um dos tipos de árvores nativas frequentemente confundida com o Pau-Brasil (Ceasalpinia echimata) devido a semelhança de suas folhas. A espécie tem uma altura média de 8 m",
  },
  {
    name: "Manacá da Serra (Tibouchina mutabilis)",
    image: arvore5,
    description:
      "Devido essa característica tão inusitada, ela é um dos tipos de árvores nativas mais utilizadas em projetos de paisagismo. A espécie também é favorável para a arborização urbana, pois apresenta raízes pouco agressivas. Sua altura pode chegar a 12 m",
  },
  // {
  //   name: "Espresso",
  //   image: espressoImage,
